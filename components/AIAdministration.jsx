    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-4 pt-4 sm:px-6 sm:pt-6">
            <CardTitle className="text-xs sm:text-sm font-medium">AI Decisions</CardTitle>
            <Brain className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground flex-shrink-0" />
          </CardHeader>
          <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
            <div className="text-xl sm:text-2xl font-bold">{stats.totalDecisions || 0}</div>
            <p className="text-[10px] sm:text-xs text-muted-foreground">Total routing decisions</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
            <div className={`text-xl sm:text-2xl font-bold ${getConfidenceColor(stats.averageConfidence || 0)}`}>
              {((stats.averageConfidence || 0) * 100).toFixed(1)}%
            </div>
            <p className="text-[10px] sm:text-xs text-muted-foreground">Average routing confidence</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-4 pt-4 sm:px-6 sm:pt-6">
            <CardTitle className="text-xs sm:text-sm font-medium">Keywords</CardTitle>
          ...
          <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
            ...
            <p className="text-[10px] sm:text-xs text-muted-foreground">
              Across {keywords.length} dept{keywords.length !== 1 ? 's' : ''}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
            <div className="text-xl sm:text-2xl font-bold">{categoryAnalytics.totalCategories}</div>
            <p className="text-[10px] sm:text-xs text-muted-foreground">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-4 pt-4 sm:px-6 sm:pt-6">
            <CardTitle className="text-xs sm:text-sm font-medium">KB Articles</CardTitle>
            <Database className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground flex-shrink-0" />
          </CardHeader>
          <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
            <div className="text-xl sm:text-2xl font-bold">{knowledgeBase.length}</div>
            <p className="text-[10px] sm:text-xs text-muted-foreground">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 h-auto p-1 gap-1">
          ...
          <TabsTrigger value="decisions" className="text-xs sm:text-sm px-2 py-2">AI Decisions</TabsTrigger>
          <TabsTrigger value="categories" className="text-xs sm:text-sm px-2 py-2">Categories</TabsTrigger>
          <TabsTrigger value="keywords" className="text-xs sm:text-sm px-2 py-2">Keywords</TabsTrigger>
          <TabsTrigger value="knowledge-base" className="text-xs sm:text-sm px-2 py-2">Knowledge Base</TabsTrigger>
        </TabsList>
