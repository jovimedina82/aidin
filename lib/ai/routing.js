...
3. Consider what department would best handle this specific issue
4. Don't just match keywords - understand the INTENT and CONTEXT
5. Be confident in your decision (aim for 0.7+ confidence when clear)
  ...
  "reasoning": "Brief explanation of routing decision"
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert support ticket routing system. Your job is to analyze tickets and route them to the correct department by understanding the full context and intent of the request, not just matching keywords. Always respond with valid JSON only, no additional text or markdown."
        },
        {
          role: "user",
          content: prompt
